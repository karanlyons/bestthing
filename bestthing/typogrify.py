...
# `force_unicode()` taken from Django. Everything else taken from Typogrify. I have put the least amount of effort possible into this file.
		...
		if not isinstance(s, basestring,):
			if hasattr(s, '__unicode__'):
				...
				try:
					...
					# output should be.
					s = u' '.join([force_unicode(arg) for arg in s])
